...
# Thêm các đặc trưng vào X_preprocessed
'''
x_box=  2  #2
y_box=   8 #3
width=    3  #4
...
features = np.array([x_box, y_box, width, high, onpix, x_bar, y_bar, x2bar, y2bar, xybar, x2ybr, xy2br, x_ege, xegvy, y_ege, yegvx])
...
# In kết quả
print("Nhãn dự đoán cho ảnh là:", label)
